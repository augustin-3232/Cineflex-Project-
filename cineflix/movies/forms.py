...
class MovieForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets={
            ...
            'video':forms.TextInput(attrs={'class':'form-select','type':'url','placeholder':'Enter the Video URL'}),

            'tags':forms.Textarea(attrs={'class':'form-control','rows':3,'placeholder':'Enter tag with #'}),
